...
$signupSuccessMessage = isset($_SESSION['signup_success']) ? $_SESSION['signup_success'] : "";
// Unset the session variable to prevent displaying the message multiple times
unset($_SESSION['signup_success']);


$signupFailMessage = isset($_SESSION['signup_fail']) ? $_SESSION['signup_fail'] : "";
// Unset the session variable to prevent displaying the message multiple times
unset($_SESSION['signup_fail']);

$emailexist = isset($_SESSION['exist']) ? $_SESSION['exist'] : "";
// Unset the session variable to prevent displaying the message multiple times
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 signup">
                        ...
                        <p>
                        Our <b>Electricity Management System</b> offers a seamless experience, allowing you to effortlessly pay your bills online, eliminating the hassle of paper transactions.You can easily access and review your past activities, providing you with detailed insights into your electricity usage and helping you identify opportunities for greater efficiency.
                        </p>
                    </div>
                    <!-- /col-lg-6 -->
                    <div class="col-lg-6">
                        <h1>Sign Up</h1>
                        <?php 
                            // echo $signupSuccessMessage;
                            // echo $signupFailMessage;
                            // echo $emailexist;
                            ...
                            echo '<table class="table">
                                    <tbody>
                                        <tr>
                                            <td class="danger">' . $signupFailMessage . '</td>
                                        </tr>
                                    </tbody>
                                </table>';
                            }
                            ...
                            echo '<table class="table">
                                    <tbody>
                                        <tr>
                                            <td class="success">' . $signupSuccessMessage . '</td>
                                        </tr>
                                    </tbody>
                                </table>';
                            }
